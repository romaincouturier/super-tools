...
- `/anonymisation-demo` — Audite et complète l'anonymisation des écrans internes avant une démo (mode démo, masques `src/lib/demoMask.ts`, ratchet de contrôle [062]).
