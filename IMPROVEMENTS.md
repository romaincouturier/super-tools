...
- **Fichiers de référence** : `supabase/functions/ted-sync/index.ts` (`TED_CPV_SETTING`, `tedConfig`), `supabase/migrations/20260805120000_ted_keywords_only.sql`, `supabase/functions/_shared/ted.ts` (en-tête : ni géographie ni langue ne filtrent)
