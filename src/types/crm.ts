...
export type AcquisitionSource = 'recommandation' | 'linkedin' | 'site_web' | 'evenement' | 'appel_froid' | 'appel_entrant' | 'email_entrant' | 'partenaire' | 'nouvelle_mission' | 'ancien_client' | 'recherche_google' | 'reseau' | 'demarchage' | 'marche_public' | 'autre';
...
export const lossReasonConfig: Record<LossReason, string> = {
  ...
  concurrent: 'A choisi une meilleure offre',
  besoin_non_qualifie: 'Besoin non qualifié',
  pas_de_budget: 'Pas de budget',
  pas_de_reponse: 'Ne répond pas',
  indisponible: 'Je ne suis pas disponible',
  no_go: 'No Go interne',
  changement_avis: 'A changé d\'avis',
  financement_cpf: 'Veut un financement CPF',
  autre: 'Autre raison',
};
