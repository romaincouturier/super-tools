...
const EditParticipantDialog = ({
  ...
  return (
    ...
    >
      ...
      <DialogContent className="max-h-[90vh] overflow-y-auto overflow-x-hidden w-full max-w-4xl">
        <DialogHeader>
        ...
        <div className="space-y-4 py-4">
          <ParticipantFormFields
            ...
            email={hook.email /* demo-safe: valeur du champ de saisie, masquer corromprait l'enregistrement */}
            setEmail={hook.setEmail}
            company={hook.company /* demo-safe: valeur du champ de saisie, masquer corromprait l'enregistrement */}
            setCompany={hook.setCompany}
            companyAddress={hook.companyAddress}
            setCompanyAddress={hook.setCompanyAddress}
            companyZip={hook.companyZip}
            setCompanyZip={hook.setCompanyZip}
            companyCity={hook.companyCity}
            setCompanyCity={hook.setCompanyCity}
          ...
          {isInterEntreprise && (
            <>
              <SponsorFormFields
                ...
                sponsorPhone={hook.sponsorPhone}
                setSponsorPhone={hook.setSponsorPhone}
