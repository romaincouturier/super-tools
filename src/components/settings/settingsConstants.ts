...
Merci d'avance pour votre participation !`,
  ...
  logistics_requirements: {
    name: "Besoins logistiques (commanditaire)",
    timing: "before",
    sendingInfo: "📤 Envoyé automatiquement au commanditaire d'une formation intra présentielle, 60 jours avant le début (ou immédiatement si la formation est créée à moins de 60 jours). Renvoyé si le commanditaire change.",
    subject: {
      tu: "Préparation logistique — Formation \"{{training_name}}\" du {{training_date}}",
      vous: "Préparation logistique — Formation \"{{training_name}}\" du {{training_date}}",
    },
    content: {
      tu: `Bonjour{{#sponsor_first_name}} {{sponsor_first_name}}{{/sponsor_first_name}},
...
Merci beaucoup pour ton aide ! N'hésite pas à me contacter si tu as la moindre question.`,
      vous: `Bonjour{{#sponsor_first_name}} {{sponsor_first_name}}{{/sponsor_first_name}},
