...
const EntityTranscriptsSection = ({ entity, entityId }: Props) => {
  ...
  const { data: links = [], isLoading } = useEntityTranscripts(entity, entityId);
  const associate = useAssociateEntityTranscript(entity);
            ...
            >
              ...
              <div className="flex items-center gap-1 shrink-0">
                ...
                <Button
                  ...
                  size="icon"
                  className="h-7 w-7"
                  onClick={() => unlink.mutate({ linkId: link.id, entityId })}
...
export default EntityTranscriptsSection;
