      ...
      <div className="p-3 sm:p-4">
        {meta.editable ? (
          ...
          <p className="text-sm text-muted-foreground italic">
            L'édition complète des blocs « {meta.label} » est prévue dans une prochaine version.
            Le bloc reste affiché dans le bon ordre côté apprenant et peut être masqué ou
            réordonné.
          </p>
        )}
      </div>
