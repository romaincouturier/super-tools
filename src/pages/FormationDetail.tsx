...
import { Loader2, ArrowLeft, Calendar, Users, FileText, User as UserIcon, Mail, MapPin, Building, Clock, Copy, Check, CheckCircle2, Euro, StickyNote, Save, Heart, Send, AlertTriangle } from "lucide-react";
...
import { FormationBookingActions } from "@/components/formations/FormationBookingActions";
    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="max-w-7xl mx-auto p-3 md:p-6">
        ...
        <div className="flex items-center justify-between mb-4 md:mb-6 gap-2">
          ...
          <FormationBookingActions
            training={training}
            id={id!}
            isMobile={isMobile}
            onTrainingUpdate={(updates) => setTraining({ ...training, ...updates })}
            onMapOpen={() => setMapDialogOpen(true)}
            onNavigateEdit={() => navigate(`/formations/${id}/edit`)}
