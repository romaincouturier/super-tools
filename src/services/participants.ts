...
export async function createParticipant(input: CreateParticipantInput) {
  const participantData = {
    ...
    company_zip: input.companyZip?.trim() || null,
    company_city: input.companyCity?.trim() || null,
    type_stagiaire_bpf: input.typeStagiaireBpf || null,
    source_financement_bpf: input.sourceFinancementBpf || null,
    ...
    ...(input.isInterEntreprise && {
      ...
      sponsor_phone: input.sponsorPhone?.trim() || null,
