...
const LmsCommunities = lazy(() => import("./pages/LmsCommunities"));
const LmsCommunityAdmin = lazy(() => import("./pages/LmsCommunityAdmin"));
...
const LmsGroupMatching = lazy(() => import("./pages/LmsGroupMatching"));
const ElearningIntegrations = lazy(() => import("./pages/ElearningIntegrations"));
        ...
        <Suspense fallback={<PageLoader />}>
          <RouteErrorBoundary>
            <Routes>
              ...
              {/* Ancien lien magique : plus de jeton à échanger, on renvoie à la
                  connexion plutôt que de laisser un vieux lien reçu par email
                  tomber sur la page "introuvable" (jamais de cul-de-sac). */}
              <Route path="/apprenant/connexion" element={<Navigate to="/connexion" replace />} />
              <Route path="/connexion/lien" element={<Navigate to="/connexion" replace />} />
              ...
              <Route element={<RequireStaff />}>
                ...
                <Route path="/lms/communautes" element={<LmsCommunities />} />
                <Route path="/lms/communautes/:courseId" element={<LmsCommunityAdmin />} />
                <Route path="/lms/faq" element={<LmsFaq />} />
                <Route path="/lms/binomes" element={<LmsGroupMatching />} />
                <Route path="/lms/integrations" element={<ElearningIntegrations />} />
