...
- [ ] Sentry JAVASCRIPT-REACT-P : upload .pptx rejeté (mime non supporté) — élargir les types acceptés
- [ ] Anna (annaivacheff@gmail.com) : publications/messages invisibles après reconnexion — retour factuel
