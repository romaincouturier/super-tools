---
name: sync-and-pr
description: Synchronise la branche courante avec main, gère les conflits de rebase, et pousse une Pull Request. Utiliser quand l'utilisateur veut synchroniser sa branche, merger main, ou créer une PR après sync.
