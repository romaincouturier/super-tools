CREATE TABLE public.event_transcripts (
...
CREATE INDEX idx_event_transcripts_event ON public.event_transcripts(event_id);
CREATE INDEX idx_event_transcripts_transcript ON public.event_transcripts(transcript_id);