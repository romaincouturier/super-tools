...
CREATE INDEX IF NOT EXISTS idx_okr_objectives_target_year ON public.okr_objectives(target_year);
CREATE INDEX IF NOT EXISTS idx_okr_objectives_status ON public.okr_objectives(status);
CREATE INDEX IF NOT EXISTS idx_okr_objectives_is_favorite ON public.okr_objectives(is_favorite);
CREATE INDEX IF NOT EXISTS idx_okr_key_results_objective_id ON public.okr_key_results(objective_id);
CREATE INDEX IF NOT EXISTS idx_okr_initiatives_key_result_id ON public.okr_initiatives(key_result_id);
CREATE INDEX IF NOT EXISTS idx_okr_participants_objective_id ON public.okr_participants(objective_id);
CREATE INDEX IF NOT EXISTS idx_okr_check_ins_objective_id ON public.okr_check_ins(objective_id);