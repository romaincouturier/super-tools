...
-- ============================================================
-- Fusion de 20260310110000_quotes_legal_compliance.sql
--
-- Les deux fichiers portaient la même version 20260310110000. La CLI Supabase
-- indexe schema_migrations sur cette version : au rejeu, le second fichier
-- provoquait `duplicate key value violates unique constraint
-- schema_migrations_pkey`. Les deux corps sont appliqués en production, ils
-- sont donc réunis ici sous la version que la production a enregistrée.
-- ============================================================
-- ============================================================
