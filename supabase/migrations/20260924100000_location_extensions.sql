...
--
-- Une prolongation se rattache à la ligne de commande d'origine : elle porte
-- sa période, son montant HT, son avenant (PDF Monkey + signature en ligne)
-- et sa facture brouillon Pennylane. La date de fin courante de la location
-- vit sur order_items.location_end_date.
-- ═══════════════════════════════════════════════════════════════
...
-- Une signature porte soit le contrat d'origine (extension nulle), soit un avenant.
