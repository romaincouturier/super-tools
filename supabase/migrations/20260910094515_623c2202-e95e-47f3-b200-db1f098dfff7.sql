-- Enrichit get_learner_portal_data avec les informations nécessaires à
-- l'affichage unifié des formations dans l'espace apprenant :
--   - documents        : fichiers réellement affichables (training_documents + participant_files)
--   - has_documents    : périmètre exact de l'onglet Documents (jamais d'onglet vide)
--   - has_coaching     : basé sur training_participants.coaching_sessions_total
--   - last_activity_at : dernière consultation LMS, pour le tri par activité
-- Aucune nouvelle table ni colonne.
