-- Feature: signed quote PDF visible in opportunity + auto-add participant to inter-company training

-- Add crm_card_id so we can query signed devis directly from an opportunity
