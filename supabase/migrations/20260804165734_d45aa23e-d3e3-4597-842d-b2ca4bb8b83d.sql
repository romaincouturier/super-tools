...
COMMENT ON COLUMN public.api_usage_events.external_id IS
  'Identifiant de l''unité facturée chez le provider (ex: transcript_id AssemblyAI). Garantit un seul événement de coût quand la ressource est relue plusieurs fois.';
