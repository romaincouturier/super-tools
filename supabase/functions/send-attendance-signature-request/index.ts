      ...
      try {
        ...
        const htmlContent = `
          ...
          <p style="margin: 25px 0;">
            <a href="${signatureUrl}" style="display: inline-block; background-color: #eab308; color: #1a1a1a; padding: 14px 28px; text-decoration: none; border-radius: 6px; font-weight: bold;">
