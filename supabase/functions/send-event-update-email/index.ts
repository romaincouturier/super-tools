...
<body style="font-family: Arial, sans-serif; font-size: 14px; line-height: 1.6; color: #333; margin: 0; padding: 0;">
  <div style="max-width: 600px; padding: 20px;">
    ...
    <div style="margin: 24px 0; text-align: left;">
      <a href="${eventLink}" style="display: inline-block; background-color: #e6bc00; color: #000; text-decoration: none; padding: 12px 24px; border-radius: 8px; font-weight: 600; font-size: 14px;">
        Voir l'événement →
      </a>
    </div>
