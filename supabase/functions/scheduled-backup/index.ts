...
const TABLES_TO_BACKUP = [
  ...
  "crm_revenue_targets", "crm_settings", "crm_tags",
  ...
  "game_authors", "game_expenses", "game_sales", "games",
  ...
  "improvements", "inbound_emails",
  "learner_magic_links", "learner_profiles",
  "lms_assignment_submissions", "lms_assignments", "lms_badge_awards", "lms_badges",
  "lms_courses", "lms_deposit_comments", "lms_deposit_feedback", "lms_deposit_reactions",
  ...
  "location_contract_signatures", "logistics_checklist_items",
  "media",
  ...
  "training_evaluations", "training_live_meetings", "training_media",
