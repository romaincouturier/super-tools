  ...
  try {
    ...
    const htmlContent = `
      ...
      <p style="margin: 24px 0;">
        <a href="${questionnaireUrl}" style="display: inline-block; background-color: #eab308; color: #1a1a1a; padding: 14px 28px; text-decoration: none; border-radius: 8px; font-weight: bold; font-size: 16px;">
